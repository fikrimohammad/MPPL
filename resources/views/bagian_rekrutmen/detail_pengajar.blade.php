...
<head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/jadwal_pelatihan.css">
</head>
<body>
        ...
        <div class="container">
            ...
            <h4 class="text-center py-3">SMA 1 Pulo Aceh</h4>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-3">
                                    <div class="text-center">
                                        <a href="input_data_pengajar_lulus.php"><img src="../logo/back-button.png" alt="Card image cap" style="width: 32px; height: 32px;"></a>  
                                    </div>
