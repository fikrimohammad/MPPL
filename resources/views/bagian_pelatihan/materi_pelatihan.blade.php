                    ...
                    <table class="table table-hover font-weight-bold">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">1</th>
                                <td>Mark</td>
                                <td><a href="">Delete</a> | <a href="edit_materi.php">Edit</a> | <a href="detail_materi.php">Show</a></td>
                            </tr>
                            <tr>
                                <th scope="row">2</th>
                                <td>Jacob</td>
                               <td><a href="">Delete</a> | <a href="">Edit</a> | <a href="">Show</a></td>
                            </tr>
                            <tr>
                                <th scope="row">3</th>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-4">
                                    <button type="submit" class="text-center" id="submit_button">
                                        <a href="materi_pelatihan_upload.php"><img src="../logo/save.png" alt="Card image cap" style="width: 32px; height: 32px;"></a>
                                    </button>
