                    ...
                    <table class="table table-hover font-weight-bold">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Otto</td>
                                <td>@mdo</td>
                                <td><a href="edit_data_pelatihan.php">Edit</a> | <a href="">Delete</a> | <a href="detail_pelatihan.php">Show</a></td>
                            </tr>
                            <tr>
                                <th scope="row">2</th>
                                <td>Jacob</td>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-4">
                                    <button type="submit" class="text-center" id="submit_button">
                                        <a href="form_pengisian_jadwal_pelatihan.php"><img src="../logo/save.png" alt="Card image cap" style="width: 32px; height: 32px;"></a>
                                    </button>
