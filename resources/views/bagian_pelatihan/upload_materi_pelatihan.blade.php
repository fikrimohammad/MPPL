...
<head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/materi_pelatihan_upload.css">
</head>
<body>
        ...
        <div class="container">
            ...
            <div class="row pt-3 pb-5 justify-content-center">
                <div class="col-sm-8 mx-5 text-center">
                    <h4 class="pb-5">Mengunggah Materi Pelatihan</h4>
                    <div class="upload-drop-zone" id="drop-zone">
                        <div class="text-center">
                            <img src="../logo/cloud-computing.png" style="width: 128px; height: 128px;">     
                        </div>
                        <h4 class="text-center">Drag And Drop Materi Pelatihan Disini</h4>
                    </div>
