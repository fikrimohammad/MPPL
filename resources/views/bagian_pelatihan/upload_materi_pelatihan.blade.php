...
@section('content')
    ...
    <div class="container">
        <form action="{{ route('materi_pelatihan.store') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field()  }}
                ...
                <div class="row pt-4 pb-2 justify-content-center">
                    <div class="col-sm-10">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="nama_materi_pelatihan" name="nama_materi_pelatihan">
                            </div>
                        </div>
                    </div>
                </div>
