...
<body>
        ...
        <div class="container">
            ...
            <form action="form_pengisian_kelompok_pengajar_process.php" method="POST">
                <div class="row pb-2 justify-content-center">
                    ...
                    ?>        
                        ...
                        <div class="row py-2 justify-content-center">
                            <div class="col-sm-8">
                                <div class="form-group row">
                                    <label class="col-sm-5 col-form-label" for="idPengajar">ID Pengajar <?php echo $i; ?>  </label>
                                    <div class="col-sm-2 ">
                                    ...
                                    <div class="col-sm-3" style="margin-left: -40px;">
                                        <input type="text" class="form-control" id="idPengajar" name="idPengajar_<?php echo $i; ?>">    
                                    </div>  
                                </div>
                            </div>
                        </div>
