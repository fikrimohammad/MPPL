                    ...
                    <table class="table table-hover font-weight-bold">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>KP01</td>
                                <td>@mdo</td>
                                <td><a href="edit_kelompok.php">Edit</a> | <a href="">Delete</a> | <a href="detail_kelompok.php">Show</a></td>
                            </tr>
                            <tr>
                                <th scope="row">2</th>
                                <td>KP02</td>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-4">
                                    <button type="submit" class="text-center" id="submit_button">
                                        <a href="form_pengisian_kelompok_pengajar.php"><img src="../logo/save.png" alt="Card image cap" style="width: 32px; height: 32px;"></a>
                                    </button>
